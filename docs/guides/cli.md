...
銘柄コードを省略すると、当日もしくは翌営業日における全銘柄の最新情報を取得できます。
...
銘柄コードあるいは日付を指定したときは、表示されたデータフレームは保存されずに
プログラムは終了します。
...
- `arg` 引数で銘柄コードあるいは日付を指定すると、指定した銘柄あるいは日付に関する情報を取得します。
  省略すると、当日の情報を取得します。
