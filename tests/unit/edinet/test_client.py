...
@pytest.mark.asyncio
async def test_get_list_success(get: AsyncMock, mocker: MockerFixture) -> None:
    ...
    mock_clean_list = mocker.patch("kabukit.edinet.client.clean_list")
...
@pytest.mark.asyncio
async def test_get_list_no_results(get: AsyncMock, mocker: MockerFixture) -> None:
...
@pytest.mark.asyncio
async def test_get_list_empty_results(get: AsyncMock, mocker: MockerFixture) -> None:
